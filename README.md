...
さらに9人それぞれについて、村人・人狼・占い師・霊媒師・狩人・狂人の6役職別に行動方針を定義しています。試合では割り当てられた座席と実役職に対応する1件だけがプロンプトへ自動挿入され、同じ役職でも誰が担当するかによってCO、誘導、投票、占い、護衛、襲撃の傾向が変わります。

他の8人への呼び方も話者ごとに固定しています。下の名前＋さん、ちゃん／くん付け、名字＋さん、呼び捨てを人格と距離感に合わせて使い分け、Agent番号では呼びません。

占い師・霊媒師が能力結果を初めて公表するときは、同じ発言内で役職COも行います。また、第0夜には襲撃がないため1日目の「犠牲者なし」は表示せず、1日目は最初のAI発言から始まります。
