...
占い師・霊媒師は局面に応じて役職を明かし、狂人や一部の人狼もseedと状況に応じて占い師・霊媒師を騙ります。公開された役職名乗りと結果は「本人の主張」として役職主張ボードへ残り、システムは真偽を証明しません。発話では人狼用語のアルファベット略語を使いません。また、第0夜には襲撃がないため1日目の「犠牲者なし」は表示せず、1日目は最初のAI発言から始まります。

## 観戦画面の見方

- ヘッダーで現在の日・フェーズ・生存数を確認できます。GM視点と終了後は、生存する人狼数も表示します。
- 各プレイヤーカードには最新発言、死亡日と死因、直近の投票先を表示します。
- 役職主張ボードには占い師・霊媒師を名乗った人物と、その人物が公表した結果だけを表示します。真役職や真結果の印ではありません。
