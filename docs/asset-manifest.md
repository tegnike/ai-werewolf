...
| `agents/agent_1.png` | 名取 澪の立ち絵 | 琥珀色を差し色にした赤褐色ボブの成人女性、恩着せがましい世話焼き |
| `agents/agent_2.png` | 天満 ひなたの立ち絵 | ライム色のリボンを差し色にした茶髪の若い女性、ノリで賭けるお祭り娘 |
| `agents/agent_3.png` | 宮下 さくらの立ち絵 | 空色を差し色にした茶色のポニーテールの若い女性、嫌われたくない風見鶏 |
| `agents/agent_4.png` | 雨宮 しずくの立ち絵 | ミント色を差し色にした濃い青緑髪の成人女性、規律と記録の優等生 |
| `agents/agent_5.png` | 神崎 レナの立ち絵 | ローズ色を差し色にした長い深紅髪の成人女性、負けを認めない論客 |
| `agents/agent_6.png` | 黒田 剛の立ち絵 | 黄土色を差し色にした黒い短髪の成人男性、初見で決める頑固一徹 |
| `agents/agent_7.png` | 真壁 陽太の立ち絵 | オレンジを差し色にした砂色の無造作髪の若い男性、ゼロか百かの熱血漢 |
| `agents/agent_8.png` | 福本 源蔵の立ち絵 | コバルトを差し色にした銀髪と白ひげの老人男性、見栄っ張りの自称大ベテラン |
| `agents/agent_9.png` | 久遠 ひよりの立ち絵 | シアンを差し色にした紫がかった黒髪の若い女性、全部を疑う悲観主義者 |
...
- `agent_2.png` と `agent_8.png` は2026-07-19にCodex組み込み `imagegen` で再生成し、既存の画風・夜の村・胸上構図を維持しながら新人格の年齢・性別・雰囲気を反映した。
