...
- その日の先頭発言者は、まだ起きていない当日の沈黙、反応、便乗、返答遅延を観察したように話さない。全話者は仮定・方針・弱い違和感を、具体的な告発へ勝手に強めない。
...
- 後続話者には、候補ごとの投票予定人数だけでなく、疑いを出した人数、根拠分類、公開された占い・霊媒結果と同役職主張人数をまとめた証拠台帳と、不足している貢献候補を渡す。投票予定の人数自体は証拠として扱わせず、同じ質問の反復より、独自の灰評価、弁明、役職候補の扱い、処刑方針を優先させる。候補は台詞や結論を固定する台本にはしない。
