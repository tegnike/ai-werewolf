...
- 新規試合は第0夜、1日目の順に開始を画面全面で示す。1日目の演出は第0夜の占い結果確認後、最初の発言より前に表示し、全画面演出中はVOICEと発言表示を待機させる。以後も夜明けの日数、投票開始、開票、処刑を短い切替演出で示す。襲撃犠牲者と処刑者は名前を表示し、それぞれ専用のCC0効果音を鳴らす。効果音は独立してON/OFFでき、再読込・再接続・視点切替で過去イベントを重複再生しない。
