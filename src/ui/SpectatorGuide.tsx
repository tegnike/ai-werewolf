  ...
  return <>
    ...
    <dialog className="spectator-guide" ref={dialogRef} aria-labelledby="spectator-guide-title">
      ...
      <div className="guide-body">
        ...
        <section aria-labelledby="guide-flow"><h3 id="guide-flow">昼と夜の進行</h3><ol className="guide-flow"><li><span>昼</span>生存者が2周発言</li><li><span>投票</span>全票確定後に記名開票</li><li><span>処刑</span>最多得票者を処刑</li><li><span>夜</span>人狼・各役職が秘密に行動</li><li><span>夜明け</span>犠牲者を公開して次の日へ</li></ol></section>
