...
export const AGENT_VOICES: AgentVoice[] = [
  ...
  { seat: 'seat-2', speakerId: 3, speakerName: 'ずんだもん', styleName: 'ノーマル', presentation: 'androgynous' },
  ...
  { seat: 'seat-8', speakerId: 13, speakerName: '青山龍星', styleName: 'ノーマル', presentation: 'male' },
