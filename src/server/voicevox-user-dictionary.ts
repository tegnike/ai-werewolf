...
export const AGENT_NAME_DICTIONARY: readonly VoicevoxDictionaryEntry[] = [
  ...
  { surface: '青木', pronunciation: 'アオキ', accentType: 0 },
  { surface: '征司', pronunciation: 'セージ', accentType: 1 },
  ...
  { surface: '青木さん', pronunciation: 'アオキサン', accentType: 0 },
  { surface: '征司さん', pronunciation: 'セージサン', accentType: 1 },
