...
const observations: Record<string, string[]> = {
  ...
  'seat-2': [
    ...
    'わかんないけど、ひよりが急に黙ったの気になる！ ……こういう勘、外すんだけどね。',
  ],
  'seat-3': [
  ...
  'seat-4': [
    'すみません、細かいかもしれませんが……陽太さん、さっきは「信じる」と言ったのに、今は疑っているんですよね。その間が気になります。',
    '私の勘違いなら本当にごめんなさい。でも、征司さんの説明、結論が先に決まっていたようにも聞こえて……。',
    '待って、今決めるんですか？ 私、まだレナさんの言葉を整理できていなくて。間違えるのが怖いです。',
  ],
  'seat-5': [
  ...
  'seat-8': [
    'まあ、焦らずに。今日は候補を二人に絞れば十分です。こはるさん、思いつきだけで場を乱すのは感心しませんね。',
    '先を考えれば分かることです。ここで陽太さんの感情に付き合って、明日の材料を失うべきではないでしょう。',
    '……困りましたね。私の想定とは違いますが、今さら進行を崩すより、この線で行くしかありません。',
  ],
  'seat-9': [
    'あの……さくらさん、さっきは「こはるちゃん」だったのに、疑い始めたら「こはるさん」になりました。気のせい、でしょうか。',
